create index if not exists idx_agency_id on agency (id);
create index if not exists idx_stop_id on stop (id);
create index if not exists idx_route_id on route (id);
create index if not exists idx_trip_id on trip (id);
create index if not exists idx_stop_time_trip_id_sequence on stop_time (trip_id, sequence);
